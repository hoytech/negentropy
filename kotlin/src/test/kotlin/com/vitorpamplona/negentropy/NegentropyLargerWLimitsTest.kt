...
class NegentropyLargerWLimitsTest {
    ...
    fun storageP1() = StorageVector().apply { load("/clientWLimits.txt", this) }

    fun storageP2() = StorageVector().apply { load("/serverWLimits.txt", this) }
    ...
    fun testReconcile() {
        ...
        val (init, elapsed) = measureTimedValue { neClient.initiate() }
        ...
        // send to the server.
        var (result, elapsed2) = measureTimedValue { neServer.reconcile(init) }
